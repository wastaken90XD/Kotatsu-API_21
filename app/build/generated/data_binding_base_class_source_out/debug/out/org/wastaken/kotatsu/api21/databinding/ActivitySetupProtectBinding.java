...
public final class ActivitySetupProtectBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySetupProtectBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull MaterialSwitch switchBiometric, @NonNull TextView textViewSubtitle,
  ...
  @NonNull
  public static ActivitySetupProtectBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySetupProtectBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_setup_protect, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySetupProtectBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySetupProtectBinding((ConstraintLayout) rootView, buttonCancel, buttonNext,
          editPassword, layoutPassword, switchBiometric, textViewSubtitle, textViewTitle);
    }
