...
public final class ActivitySearchBinding implements ViewBinding {
  ...
  private ActivitySearchBinding(@NonNull CoordinatorLayout rootView, @NonNull AppBarLayout appbar,
      @NonNull FastScrollRecyclerView recyclerView, @NonNull MaterialToolbar toolbar) {
  ...
  public static ActivitySearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySearchBinding((CoordinatorLayout) rootView, appbar, recyclerView, toolbar);
    }
