package org.wastaken.kotatsu.api21.scrobbling
...
import org.wastaken.kotatsu.api21.core.network.CurlLoggingInterceptor
import org.wastaken.kotatsu.api21.scrobbling.anilist.data.AniListAuthenticator
import org.wastaken.kotatsu.api21.scrobbling.anilist.data.AniListInterceptor
import org.wastaken.kotatsu.api21.scrobbling.anilist.domain.AniListScrobbler
import org.wastaken.kotatsu.api21.scrobbling.common.data.ScrobblerStorage
...
import org.wastaken.kotatsu.api21.scrobbling.common.domain.model.ScrobblerType
import org.wastaken.kotatsu.api21.scrobbling.kitsu.data.KitsuAuthenticator
import org.wastaken.kotatsu.api21.scrobbling.kitsu.data.KitsuInterceptor
import org.wastaken.kotatsu.api21.scrobbling.kitsu.data.KitsuRepository
import org.wastaken.kotatsu.api21.scrobbling.kitsu.domain.KitsuScrobbler
import org.wastaken.kotatsu.api21.scrobbling.mal.data.MALAuthenticator
import org.wastaken.kotatsu.api21.scrobbling.mal.data.MALInterceptor
import org.wastaken.kotatsu.api21.scrobbling.mal.domain.MALScrobbler
import org.wastaken.kotatsu.api21.scrobbling.shikimori.data.ShikimoriAuthenticator
import org.wastaken.kotatsu.api21.scrobbling.shikimori.data.ShikimoriInterceptor
import org.wastaken.kotatsu.api21.scrobbling.shikimori.domain.ShikimoriScrobbler
