package org.wastaken.kotatsu.api21.suggestions.ui
...
import org.wastaken.kotatsu.api21.core.model.getLocale
...
import org.wastaken.kotatsu.api21.core.util.LocaleComparator
import org.wastaken.kotatsu.api21.core.util.ext.asArrayList
import org.wastaken.kotatsu.api21.core.util.ext.awaitUniqueWorkInfoByName
...
import org.wastaken.kotatsu.api21.core.util.ext.flatten
...
import org.wastaken.kotatsu.api21.core.util.ext.sanitize
import org.wastaken.kotatsu.api21.core.util.ext.takeMostFrequent
import org.wastaken.kotatsu.api21.core.util.ext.toBitmapOrNull
import org.wastaken.kotatsu.api21.core.util.ext.trySetForeground
...
import org.wastaken.kotatsu.api21.settings.work.PeriodicWorkScheduler
import org.wastaken.kotatsu.api21.suggestions.domain.MangaSuggestion
import org.wastaken.kotatsu.api21.suggestions.domain.SuggestionRepository
...
class SuggestionsWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "org.wastaken.kotatsu.api21.SUGGESTIONS"
