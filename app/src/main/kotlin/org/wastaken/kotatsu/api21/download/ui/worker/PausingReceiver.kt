...
import org.wastaken.kotatsu.api21.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "org.wastaken.kotatsu.api21.download.PAUSE"
		private const val ACTION_RESUME = "org.wastaken.kotatsu.api21.download.RESUME"
		private const val ACTION_SKIP = "org.wastaken.kotatsu.api21.download.SKIP"
		private const val ACTION_SKIP_ALL = "org.wastaken.kotatsu.api21.download.SKIP_ALL"
